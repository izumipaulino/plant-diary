...
const EVENTS = {
  positive: [
    ...
    { text: 'Another centimeter of growth recorded.', weight: 2 },
    { text: 'The morning dew settled perfectly on each leaf.', weight: 1 },
    { text: 'New root tips visible at the drainage holes.', weight: 1 },
    { text: 'Thicker stem than last week.', weight: 2 },
    { text: 'Second branch beginning to form.', weight: 1 },
  ],
  neutral: [
    ...
    { text: 'Same height as yesterday. Same leaves.', weight: 2 },
    { text: 'Clouds all day. No direct sun.', weight: 1 },
    { text: 'The pot was turned 90 degrees.', weight: 1 },
    { text: 'Dust settled on the upper leaves.', weight: 1 },
  ],
  negative: [
    ...
    { text: 'Lower leaves falling. Maybe normal.', weight: 2 },
    { text: 'Brown spots on the third leaf.', weight: 1 },
    { text: 'Growth has slowed significantly.', weight: 2 },
